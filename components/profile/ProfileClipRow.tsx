      ...
      {owned && (
        ...
        >
          <button
            ...
            className="border-2 border-hardbox bg-surface-raised px-3 py-1.5 text-[12px] font-bold text-ink-plus hover:shadow-[2px_2px_0_var(--color-hardbox-offset)]"
          >
            Edit
          </button>
          <button
            ...
            className="border-2 border-accred bg-surface-raised px-3 py-1.5 text-[12px] font-bold text-accred hover:bg-accred hover:text-white"
          >
            Delete
          </button>
        </div>
